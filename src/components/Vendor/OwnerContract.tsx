...
export default class OwnerContract extends React.Component {
  render() {
    return (
        <div className="page-content license-check owner-contract">
            ...
            <div className="main-content mt-5">
                ...
                <div className="box">
                    ...
                    <h5 className="subtitle">
                        We’ve pre-populated this information based on project address.
                    ...
                    <div className="flex align-center justify-end">
                        <Link
                            to={"/vendor/create-contract/contract-license/license-check/contract-license"}
                            className="btn filled primary w-xxxs h-sm mr-1 icon"
                        >
                            <i className="icon-left-arrow-icon" />
                        </Link>
                        <Link to={'/vendor/create-contract/contract-license/license-check/contract-license/owner-contract/contract-details'} className="btn filled primary w-xs h-sm continue">
                            continue
                        </Link>
                    </div>
                </div>
